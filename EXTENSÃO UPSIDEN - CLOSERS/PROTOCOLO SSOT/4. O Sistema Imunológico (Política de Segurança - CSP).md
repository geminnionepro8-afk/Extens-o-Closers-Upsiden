An optional manifest key containing a web platform [content security policy](https://developer.mozilla.org/docs/Web/HTTP/CSP) which specifies restrictions on the scripts, styles, and other resources an extension can use. Within this manifest key, separate optional policies can be defined for both extension pages and sandboxed extension pages.
