...
scripts](https://developer.chrome.com/docs/extensions/develop/concepts/content-scripts). But by using the [`chrome.scripting`](https://developer.chrome.com/docs/extensions/reference/scripting) namespace, extensions
...
API](https://developer.chrome.com/docs/extensions/reference/api/webNavigation).  
...
#### Properties
  ...
  - world  
  [ExecutionWorld](https://developer.chrome.com/docs/extensions/reference/api/scripting#type-ExecutionWorld) optional  
  Chrome 102+
...
): Promise<https://developer.chrome.com/docs/extensions/reference/api/scripting#type-InjectionResult[]>
```
...
): Promise<https://developer.chrome.com/docs/extensions/reference/api/scripting#type-RegisteredContentScript[]>
```
