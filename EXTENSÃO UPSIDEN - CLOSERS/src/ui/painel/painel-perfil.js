  ...
  let html = `
    <div class="perfil-container animate-in">
      <div class="perfil-header-glass">
        ...
        <input type="file" id="perfil-avatar-upload" accept="image/*" style="display:none;" onchange="handlePerfilAvatar(event)" />
        
        <div class="perfil-avatar-wrapper" onclick="document.getElementById('perfil-avatar-upload').click()" title="Alterar Logotipo">
      ...
      <div class="perfil-form-area">
        ...
        <div class="perfil-actions">
          <button class="btn-perfil-save" onclick="salvarPerfil()">
...
window.handlePerfilAvatar = async function(e) {
  ...
  try {
    ...
    toast('Erro de rede: Banco local substituido', 'error');
  } finally {
    const btn = document.querySelector('.btn-perfil-save');
