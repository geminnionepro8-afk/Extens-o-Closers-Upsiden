 ...
 * @description Este arquivo e responsavel por localizar a barra de navegacao lateral
 *              do WhatsApp Web e injetar os controles visuais da Upsiden:
 *              - O botao-logo que alterna entre o modo WhatsApp e o modo Upsiden.
 *              - A lista de ferramentas (icones SVG) que aparecem quando o modo Upsiden esta ativo.
 *              Cada ferramenta corresponde a um modulo (Audios, Documentos, CRM, etc).
 *              Quando clica no logo, os icones nativos do WhatsApp sao escondidos
 *              e substituidos pelas ferramentas Upsiden. Clicar novamente restaura tudo.
 * @module Modulo 06: Content Scripts - Injecao na Nav
...
// === Definicao dos Modulos (ferramentas da sidebar) ===
const MODULOS = [
  ...
  { tela: 'audios',       title: 'Biblioteca de Audios',  iframe: 'src/ui/modules/audios.html',
  ...
  { tela: 'midias',       title: 'Midias',                iframe: 'src/ui/modules/midias.html',
  ...
  { tela: 'auto_reply',   title: 'Resposta Automatica',    iframe: 'src/ui/modules/saudacao.html',
  ...
  { tela: 'admin',        title: 'Gestao da Equipe',       iframe: 'src/ui/modules/admin.html',
...
// === Localizar a barra de navegacao lateral do WhatsApp ===
/**
 ...
 * posicao a esquerda) e pela presenca de pelo menos 3 botoes.
...
function voltarParaWhatsApp() {
  ...
  // Restaurar nativos: REMOVER a propriedade display forcada
...
// === Injetar controles na barra de navegacao ===
/**
 * Cria o botao-logo da Upsiden e o container de ferramentas,
 * e os insere no topo da barra de navegacao do WhatsApp Web.
 * @param {HTMLElement} nav - O elemento da barra de navegacao do WhatsApp.
 */
function injetarNaNav(nav) {
  ...
  // Container de ferramentas (oculto por padrao)
  ...
  MODULOS.forEach(mod => {
    ...
    btn.addEventListener('click', (e) => {
      ...
      console.log(CTX, 'Clicou no modulo:', mod.tela, 'Aberto?', aberto, 'Mesmo?', mesmo);
